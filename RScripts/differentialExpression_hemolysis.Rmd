...
up_miRs <- filter(topTable_hemo, logFC > 0.9) %>%
...
top_DE_classifier <- dplyr::filter(up_miRs[,c("SYMBOL", "logFC", "rank_logFC")], between(rank_logFC, 1, 60)) %>% 
...
## join miRs DE between pregnant and non-pregnant DE -> only keep miRs not significant in the pregancy comparison
...
## Plotting side by side distributions - 16 classifier miRs
...
dplyr::select(as.data.frame(cpm(DGElist_plasma$counts, log = TRUE)), plotVar) %>%
  ...
  geom_vline(data = cdat,
             aes(xintercept = expression.median,
                 ...
                 linetype = "dashed"),
             show.legend = FALSE) +
  labs(title = paste(plotVar, "Denisty of CPM counts"),
 ...
 dplyr::select(as.data.frame(cpm(DGElist_plasma$counts, log = TRUE)), plotVar) %>%
  ...
  geom_vline(data = cdat,
             aes(xintercept = expression.median,
                 ...
                 linetype = "dashed"),
             show.legend = FALSE) +
  labs(title = paste(plotVar, "Histogram of CPM counts"),
       subtitle = "Smallest dCq",
       x = "log2 CPM Counts",
       y = "Count") +
  scale_fill_discrete(name = "Classifier \nStatus", labels = c("Non-Classifier", "Classifier")) +
...
## calculate the difference between the median of the distributions for all samples - 18 classifier miRs
...
## Plotting side by side distributions - 36 classifier miRs
...
dplyr::select(as.data.frame(cpm(DGElist_plasma$counts, log = TRUE)), plotVar) %>%
  ...
  geom_vline(data = cdat,
             aes(xintercept = expression.median,
                 ...
                 linetype = "dashed"),
             show.legend = FALSE) +
  labs(title = paste(plotVar, "Denisty of CPM counts (30)"),
       subtitle = "Smallest dCq",
       x = "log2 CPM Counts",
       y = "Density") +
  scale_fill_discrete(name = "Classifier \nStatus", labels = c("Non-Classifier", "Classifier")) +
...
dplyr::select(as.data.frame(cpm(DGElist_plasma$counts, log = TRUE)), plotVar) %>%
  ...
  geom_vline(data = cdat2,
             aes(xintercept = expression.median,
                 ...
                 linetype = "dashed"),
             show.legend = FALSE) +
  labs(title = paste(plotVar, "Histogram of CPM counts (30)"),
       subtitle = "Smallest dCq",
       x = "log2 CPM Counts",
       y = "Count") +
  scale_fill_discrete(name = "Classifier \nStatus", labels = c("Non-Classifier", "Classifier")) +
...
## calculate the difference between the median of the distributions for all samples (36 classifier miRs)
...
dplyr::select(as.data.frame(cpm(DGElist_plasma$counts, log = TRUE)), plotVar) %>%
  ...
  geom_vline(xintercept = twentyFifth,
             linetype = "dotted") +
  labs(title = paste(plotVar, "Histogram of CPM counts (16)"),
       subtitle = "dCq = 7",
       x = "log2 CPM Counts",
       y = "Count") +
  scale_fill_discrete(name = "Classifier \nStatus", labels = c("Non-Classifier", "Classifier")) +
